 ...
 */
public class ExemploCRUD extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("testPU").createEntityManager();
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT m FROM Mestre m");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                ExemploCRUD.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                ExemploCRUD.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                ExemploCRUD.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                ExemploCRUD.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<br.com.ftec.exemplo.crud.Mestre> toRemove = new ArrayList<br.com.ftec.exemplo.crud.Mestre>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            br.com.ftec.exemplo.crud.Mestre m = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(m);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        br.com.ftec.exemplo.crud.Mestre m = new br.com.ftec.exemplo.crud.Mestre();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<br.com.ftec.exemplo.crud.Mestre> merged = new ArrayList<br.com.ftec.exemplo.crud.Mestre>(list.size());
            for (br.com.ftec.exemplo.crud.Mestre m : list) {
    ...
    private java.util.List<br.com.ftec.exemplo.crud.Mestre> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExemploCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new ExemploCRUD());
